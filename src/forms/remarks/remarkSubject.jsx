...
export default function RemarkSubject({ disabledInput }) {
  const { setValue } = useFormContext();
  const handleServerErrors = useServerErrors();
  const { remark_subject_ozviat_type } = useWatch();
  ...
  const handleSubmitRequest = async (value) => {
    ...
    } else if (remark_subject_ozviat_type === 2) {
      try {
      ...
      <Grid container>
        <Grid item xs={12}>
          ...
          >
            ...
            <Select
              labelId="remark_subject_ozviat_type-label"
              id="remark_subject_ozviat_type"
              label={<RequiredFieldIcon label="نوع عضویت" />}
              name="remark_subject_ozviat_type"
            ...
            {!remark_subject_ozviat_type ? (
              <CustomSearchInput id="remark_subject_search1" disabled />
            ) : (
              <CustomSearchInput
                id="remark_subject_search2"
          ...
          >
            <Grid container spacing={1}>
              <Grid item xs={4}>
                <CustomTextField
                  variant="outlined"
                  name="remark_subject_pasdari_code"
                  size="small"
              ...
              <Grid item xs={4}>
                <CustomTextField
                  variant="outlined"
                  name="remark_subject_parvande_code"
                  size="small"
              ...
              <Grid item xs={4}>
                <CustomTextField
                  variant="outlined"
                  name="remark_subject_fathername"
                  size="small"
              ...
              <Grid item xs={4}>
                <CustomTextField
                  variant="outlined"
                  name="remark_subject_nationality_code"
                  size="small"
              ...
              <Grid item xs={4}>
                <CustomTextField
                  variant="outlined"
                  name="remark_subject_ozviat_code"
                  size="small"
                  label={<RequiredFieldIcon label="نوع عضویت" />}
                  disabled
                />
