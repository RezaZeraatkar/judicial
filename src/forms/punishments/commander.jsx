...
export default function Commander({ disableInputs }) {
  ...
  function injectFormData(employee) {
    setValue("punishment_commander_pasdari_code", employee["pasdari_code"]);
    setValue("punishment_commander_parvande_code", employee["code"]);
    setValue("punishment_commander_name", employee["firstname"]);
    setValue("punishment_commander_surname", employee["surname"]);
    setValue("punishment_commander_fathername", employee["fathername"]);
    setValue("punishment_commander_nationality_code", employee["nationalcode"]);
    setValue(
      "punishment_commander_ozviyat_type",
      employee["ozviyat_type_title"],
    );
    setValue("punishment_commander_rank", employee["daraje_title"]);
    setValue("punishment_commander_position", employee["jaygah_title"]);
    setValue("punishment_commander_unit", employee["vahed_title"]);
    setValue("punishment_commander_responsibility", employee["masoliat"]);
  }
      ...
      <Grid container>
        <Grid item xs={12}>
          ...
          >
            ...
            <CustomSearchInput
              id="punishment_commander_search"
              type="text"
              isLoading={isLoading}
          ...
          >
            <Grid container spacing={1}>
              <Grid item xs={4}>
                <CustomTextField
                  variant="outlined"
                  name="punishment_commander_pasdari_code"
                  size="small"
              ...
              <Grid item xs={4}>
                <CustomTextField
                  variant="outlined"
                  name="punishment_commander_parvande_code"
                  size="small"
              ...
              <Grid item xs={4}>
                <CustomTextField
                  variant="outlined"
                  name="punishment_commander_name"
                  size="small"
              ...
              <Grid item xs={4}>
                <CustomTextField
                  variant="outlined"
                  name="punishment_commander_surname"
                  size="small"
              ...
              <Grid item xs={4}>
                <CustomTextField
                  variant="outlined"
                  name="punishment_commander_fathername"
                  size="small"
              ...
              <Grid item xs={4}>
                <CustomTextField
                  variant="outlined"
                  name="punishment_commander_nationality_code"
                  size="small"
              ...
              <Grid item xs={4}>
                <CustomTextField
                  variant="outlined"
                  name="punishment_commander_ozviyat_type"
                  size="small"
              ...
              <Grid item xs={4}>
                <CustomTextField
                  variant="outlined"
                  name="punishment_commander_rank"
                  size="small"
              ...
              <Grid item xs={4}>
                <CustomTextField
                  variant="outlined"
                  name="punishment_commander_position"
                  size="small"
              ...
              <Grid item xs={4}>
                <CustomTextField
                  variant="outlined"
                  name="punishment_commander_unit"
                  size="small"
              ...
              <Grid item xs={4}>
                <CustomTextField
                  size="small"
                  variant="outlined"
                  name="punishment_commander_responsibility"
                  label="مسئولیت"
                  disabled
                />
              </Grid>
